...
var DrawEdgeHandles = /*#__PURE__*/function (_HTMLElement) {
  _inherits(DrawEdgeHandles, _HTMLElement);
  var _super = _createSuper(DrawEdgeHandles);
  function DrawEdgeHandles() {
    _classCallCheck(this, DrawEdgeHandles);
    return _super.call(this);
  }
  _createClass(DrawEdgeHandles, [{
    ...
    value: function connectedCallback() {
      ...
      var drawOnDiv = document.getElementById('draw-on');
      var drawOffDiv = document.getElementById('draw-off');
