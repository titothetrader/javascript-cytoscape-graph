...
var DragAndDropUpload = /*#__PURE__*/function (_HTMLElement) {
  _inherits(DragAndDropUpload, _HTMLElement);
...
function handleDrop(e) {
  var dataTx = e.dataTransfer;
  var file = dataTx.files;
  handleFile(file);
}
function handleFile(file) {
  ...
  reader.onabort = function () {
    return console.log('Upload was cancelled');
  };
