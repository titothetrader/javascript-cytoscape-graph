...
var ExportButtons = /*#__PURE__*/function (_HTMLElement) {
  _inherits(ExportButtons, _HTMLElement);
  var _super = _createSuper(ExportButtons);
  function ExportButtons() {
    _classCallCheck(this, ExportButtons);
    return _super.call(this);
  }
  _createClass(ExportButtons, [{
...
function exportPNG() {
  html2canvas(document.querySelector('#graph')).then(function (canvas) {
    ...
    var title = document.getElementById('graph-title').innerHTML;
