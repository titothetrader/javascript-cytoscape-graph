...
var EdgeColor = /*#__PURE__*/function (_HTMLElement) {
  _inherits(EdgeColor, _HTMLElement);
  var _super = _createSuper(EdgeColor);
  function EdgeColor() {
    _classCallCheck(this, EdgeColor);
    return _super.call(this);
  }
  _createClass(EdgeColor, [{
    ...
    value: function connectedCallback() {
      ...
      edgeColorPicker.onChange = function (color) {
        var edgeColor = color.rgbaString;
