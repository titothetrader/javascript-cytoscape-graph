...
var NodeColor = /*#__PURE__*/function (_HTMLElement) {
  _inherits(NodeColor, _HTMLElement);
  var _super = _createSuper(NodeColor);
  function NodeColor() {
    _classCallCheck(this, NodeColor);
    return _super.call(this);
  }
  _createClass(NodeColor, [{
    ...
    value: function connectedCallback() {
      ...
      nodeColorPicker.onChange = function (color) {
        var nodeColor = color.rgbaString;
